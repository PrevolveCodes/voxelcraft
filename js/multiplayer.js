...
export class Multiplayer{
  constructor({onState,onRemote,onBlock,onError,onStatus}){
    this.onState=onState;this.onRemote=onRemote;this.onBlock=onBlock;this.onError=onError;this.onStatus=onStatus;this.worldInfo=null;
  ...
  message(conn,m){
    ...
    if(!this.isHost&&['player-join','state','player-leave','block','world-info'].includes(m.type))this.onRemote?.(m);
  }
  cleanPlayer(p,id){
